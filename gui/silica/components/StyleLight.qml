...
QtObject {
    ...
    property QtObject popover: QtObject {
        property color backgroundColor: Theme.overlayBackgroundColor // "black"
        property color foregroundColor: Theme.primaryColor // "white"
        property color highlightedColor: Theme.highlightColor // "deepskyblue"
    }
